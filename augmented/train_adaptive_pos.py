...
class AdaptiveLoss(nn.Module):
    ...
    def forward(self, predictions, targets):
        ...
        # road_loss = (road_pred - road_target)**2
        # wind_loss = (wind_pred - wind_target)**2
        # powertrain_loss = (powertrain_pred - powertrain_target)**2
        ...
        # return loss, road_loss,wind_loss, powertrain_loss
