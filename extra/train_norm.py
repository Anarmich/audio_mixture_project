...
if __name__ == "__main__":
    manifest_file = '/home/ub14693/audio_mixture_project/data_features/data_manifest.json'
    ...
    train_model(model, train_loader, num_epochs=100, learning_rate=0.0001, device='cuda' if torch.cuda.is_available() else 'cpu')
